# Newton Raphson Enhanced Control Command List
...
```bash
ros2 run newton_raphson_enhanced run --platform <PLATFORM> --trajectory <TRAJECTORY> [OPTIONS]
```
...
```bash
ros2 run newton_raphson_enhanced run --platform sim --trajectory hover --double-speed --hover-mode 6 --log-file sim_nr_enh_hover_2x.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory yaw_only --double-speed --log-file sim_nr_enh_yaw_only_2x.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory circle_horz --double-speed --log-file sim_nr_enh_circle_horz_2x.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory circle_horz --double-speed --spin --log-file sim_nr_enh_circle_horz_2x_spin.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory circle_vert --double-speed --log-file sim_nr_enh_circle_vert_2x.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory fig8_horz --double-speed --log-file sim_nr_enh_fig8_horz_2x.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory fig8_vert --double-speed --log-file sim_nr_enh_fig8_vert_2x.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory fig8_vert --double-speed --short --log-file sim_nr_enh_fig8_vert_2x_short.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory helix --double-speed --log-file sim_nr_enh_helix_2x.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory helix --double-speed --spin --log-file sim_nr_enh_helix_2x_spin.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory sawtooth --double-speed --log-file sim_nr_enh_sawtooth_2x.csv
ros2 run newton_raphson_enhanced run --platform sim --trajectory triangle --double-speed --log-file sim_nr_enh_triangle_2x.csv
```
...
ros2 run newton_raphson_enhanced run --platform sim --trajectory circle_horz

# Simulation at double speed
ros2 run newton_raphson_enhanced run --platform sim --trajectory circle_horz --double-speed

# Hardware with PyJoules monitoring at double speed
ros2 run newton_raphson_enhanced run --platform hw --trajectory fig8_vert --double-speed --pyjoules

# Custom log file
ros2 run newton_raphson_enhanced run --platform sim --trajectory helix --double-speed --log-file my_experiment.csv
```

### Common Combinations
```bash
# Regular speed testing
ros2 run newton_raphson_enhanced run --platform sim --trajectory circle_horz --log-file regular_speed_test.csv

# Double speed with energy monitoring
ros2 run newton_raphson_enhanced run --platform sim --trajectory circle_horz --double-speed --pyjoules --log-file energy_test.csv

# Performance testing at double speed
ros2 run newton_raphson_enhanced run --platform sim --trajectory fig8_vert --double-speed --log-file performance_test.csv

# Figure-8 vertical with short variant
ros2 run newton_raphson_enhanced run --platform sim --trajectory fig8_vert --double-speed --short --log-file fig8_short_test.csv

# Circle horizontal with spin
ros2 run newton_raphson_enhanced run --platform sim --trajectory circle_horz --double-speed --spin --log-file circle_spin_test.csv

# Helix with spin
ros2 run newton_raphson_enhanced run --platform sim --trajectory helix --double-speed --spin --log-file helix_spin_test.csv

# Hardware validation at regular speed
ros2 run newton_raphson_enhanced run --platform hw --trajectory hover --hover-mode 1 --pyjoules --log-file hw_validation.csv
```
