...
from newton_raphson_enhanced_utils.px4_utils.core_funcs import (
...
from newton_raphson_enhanced_utils.vehicles.platform_interface import (
    PlatformType,
    PlatformConfig,
    PLATFORM_REGISTRY
)
from newton_raphson_enhanced_utils.trajectories import (
    TrajContext,
    TrajectoryType,
    TRAJ_REGISTRY,
    generate_reference_trajectory
)
from newton_raphson_enhanced_utils.controller.nr_enhanced import newton_raphson_enhanced
# from newton_raphson_enhanced_utils.controller.nr_standard import newton_raphson_standard


from newton_raphson_enhanced_utils.main_utils import BANNER
from newton_raphson_enhanced_utils.transformations.adjust_yaw import adjust_yaw
from newton_raphson_enhanced_utils.px4_utils.flight_phases import FlightPhase
...
class OffboardControl(Node):
    ...
    def data_log_timer_callback(self) -> None:
        ...
        # if self.program_time < self.cushion_period + 5.0:
        #     return
