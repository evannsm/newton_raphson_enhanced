...
from newton_raphson_enhanced_utils.vehicles.platform_interface import PlatformType
from newton_raphson_enhanced_utils.trajectories import TrajectoryType
